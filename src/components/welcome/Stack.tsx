  ...
  return (
    <div id="stack">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 grid-rows-3 gap-5">
        ...
        <CardWithImage header="Vue / Nuxt" label="" mainText="Nuxt 3 (SSR, SSG), Vue 3 (TSX, рендер-функции, шаблоны, SPA), Vue router, Pinia, PrimeVue" middleLabel="" imgPath="https://github.com/devicons/devicon/raw/master/icons/vuejs/vuejs-original.svg" />
        ...
        <CardWithImage header="HTML/CSS" label="" mainText="Адаптивная верстка, БЭМ, flex, grid, mobile first, SASS, Tailwind CSS, PrimeFlex" middleLabel="" imgPath="https://github.com/devicons/devicon/raw/master/icons/sass/sass-original.svg" />
